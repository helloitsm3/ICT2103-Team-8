...
CREATE TABLE `movie` (
  ...
  CONSTRAINT `movie_ibfk_1` FOREIGN KEY (`review_id`) REFERENCES `review` (`review_id`),
...
-- Dump completed on 2020-10-31 16:47:32
